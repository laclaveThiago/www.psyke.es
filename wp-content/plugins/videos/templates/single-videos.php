            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <h2 class="title-hero text-center">
						<a class="back-to-blog" href="<?php echo esc_url( home_url( '/' ) ); ?>videos" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Volver a los Vídeos">Vídeos</a>
					</h2>
					<p class="text-center text-dark-gray">Reflexiones que nos ayudan a recordar la importancia de volver siempre a nuestra sabia consciencia, cada vez que la vida nos sacude y la mente nos intenta atrapar en sus elucubraciones. Cada charla y meditación grabada tiene el propósito de traernos de vuelta a la realidad sin añadirle más drama al drama y saber responder desde los recursos que poseemos en nuestro interior.</p>
                </div>    
            </div>    
        </div>
		<section class="bottom-text">
            <div class="bottom-text--inner">
                <p class="text-center">PARA RECORDAR SER MINDFUL CUANDO MÁS LO NECESITAS</p>
            </div>
        </section>
    </div>
</div>
				...
				<section class="main-content--product padding-large">
					<div class="container">
						<div class="row">
							<div class="col-md-6">
								<header class="entry-header">
									...
									<div class="entry-meta">
										<p>By Thaïs Capella / <?php echo get_the_date(); ?> / <?php if( get_post_meta( get_the_id(), 'timeVideo', true) ) : ?><strong class="meditation-time"><span class="icon-clock icon-awesome"><svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="clock" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-clock fa-w-16"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z" class=""></path></svg></span> <?php echo get_post_meta( get_the_id(), 'timeVideo', true);  endif; ?></strong>
									</div>
							...
							<div class="col-md-6">
								<?php 
									if( get_post_meta( get_the_id(), 'descriptionVideo', true) ) :
										echo do_shortcode(get_post_meta(get_the_id(), 'descriptionVideo', true)); 
									endif;
								?>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="padding-regular">
									<?php 
										if( get_post_meta( get_the_id(), 'fileVideo', true) ) : 
									?>
										<div class="embed-responsive embed-responsive-16by9">
											<video class="embed-responsive-item" controls width="720">
												<source src="<?php echo get_post_meta(get_the_id(), 'descriptionVideo', true); ?>" type="video/mp4">
						...
						<div class="row justify-content-center">
							<div class="col-md-12">
								<div class="padding-large--bottom">
									<h3 class="title-h1 text-primary title-icon title-icon--crown">Otros vídeos</h3>
								</div>
							</div>
						</div><!-- row -->
						<div class="row justify-content-center">
										...
										while( $meditaciones->have_posts() ) : 
											$meditaciones->the_post(); 
												...
												<div class="slick-item">
													<?php get_template_part( 'loop-templates/content-card--videos' ); ?>
												</div>
												<?php
										endwhile;
										wp_reset_postdata();
