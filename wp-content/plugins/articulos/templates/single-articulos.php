            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <h2 class="title-hero text-center">
						<a class="back-to-blog" href="<?php echo esc_url( home_url( '/' ) ); ?>articulos" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Volver a los Artículos">Artículos</a>
					</h2>
					...
					<div class="container">
							...
							<div class="col-md-12">
								<header class="entry-header">
									...
									<div class="entry-meta">
										<p>By Thaïs Capella / <?php echo get_the_date(); ?> 
									</div>
						...
						<div class="row">
							<div class="col-md-12">
                                ...
                                <?php  if( get_post_meta( get_the_id(), 'fileArticle', true) ) : ?>
                                    <div class="padding-regular">
                                        <a class="btn btn-primary" href="<?php echo get_post_meta(get_the_id(), 'fileArticle', true); ?>" target="_blank">Descargar artículo</a>
                                    </div>
                                <?php endif; ?>
						...
						<div class="row justify-content-center">
							<div class="col-md-12">
								<div class="padding-large--bottom">
									<h3 class="title-h1 text-primary title-icon title-icon--crown">Otros artículos</h3>
								</div>
							</div>
						</div><!-- row -->
						<div class="row justify-content-center">
										...
										while( $meditaciones->have_posts() ) : 
											$meditaciones->the_post(); 
												...
												<div class="slick-item">
													<?php get_template_part( 'loop-templates/content-card--articulos' ); ?>
												</div>
												<?php
										endwhile;
										wp_reset_postdata();
