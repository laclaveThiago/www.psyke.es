            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <h2 class="title-hero text-center">
						<a class="back-to-blog" href="<?php echo esc_url( home_url( '/' ) ); ?>meditaciones" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Volver a las Meditaciones">Meditaciones</a>
					</h2>
