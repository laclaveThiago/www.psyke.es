...
class configRetiroMetabox {
	...
	private $meta_fields = array(
		...
		array(
			...
			'default' => 'Nueve sesiones / Martes tardes de 19h a 21h',
			'type' => 'wysiwyg',
		),
        array(
			'label' => 'Fechas',
...
<div class="card-default card-default--retreat">
							...
							<div class="card-body">
								<?php if( get_post_meta( get_the_id(), 'retreatDates', true) ) : ?>	
									<div class="info-item info-item--dates">
										...
										<div class="info-item--body"><?php echo get_post_meta( get_the_id(), 'retreatDates', true) ); ?></div>
									</div>
								<?php endif; ?>
								<?php if( get_post_meta( get_the_id(), 'retreatPlace', true) ) : ?>	
									<div class="info-item info-item--place">
										<div class="info-item--icon"></div>
										<div class="info-item--body"><?php echo get_post_meta( get_the_id(), 'retreatPlace', true) ); ?></div>
									</div>
								<?php endif; ?>
								...
								<?php if( get_post_meta( get_the_id(), 'retreatPrice', true) ) : ?>	
									<div class="info-item info-item--price">
										<div class="info-item--icon"></div>
										<div class="info-item--body">
											<?php echo get_post_meta( get_the_id(), 'retreatPrice', true) ); ?>
							...
							<div class="card-footer">
								<a class="page-scroll btn btn-outline btn-outline--primary btn-sm" href="<?php echo esc_url( home_url( '/' ) ); ?>form-retiro?retiro=<?php echo get_the_id(); ?>">
